...
function evaluateFiveCards(cards) {
    var _a, _b;
    const values = cards.map(c => Card_1.RANK_VALUES[c.rank]).sort((a, b) => b - a);
    ...
    if (counts[0].count === 3 && ((_a = counts[1]) === null || _a === void 0 ? void 0 : _a.count) === 2) {
    ...
    if (counts[0].count === 2 && ((_b = counts[1]) === null || _b === void 0 ? void 0 : _b.count) === 2) {
